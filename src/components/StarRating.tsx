...
export default function StarRating() {
	...
	const onPointerLeave = () => {
		starRating ? setDisplayRating(starRating) : averageRating ? setDisplayRating(averageRating) : setDisplayRating(null);
	};
	...
	return (
		<div className="flex items-end my-3 pb-md-4 justify-start w-full max-w-sm">
			...
			{displayRating ? <p className="text-center text-lg mx-4 w-[32px]">({displayRating.toFixed(0)})</p> : <p className="text-center text-lg mx-4 w-[32px]">(?)</p>}
		</div>
	);
}
