	...
	return (
		<>
			...
			<main className="flex flex-col p-6 min-h-screen bg-page-bg dark:bg-gray-dark ">
				<div className="flex flex-1 flex-col items-center justify-center mx-auto w-full sans text-center gap-4">
					<h1 className="text-4xl font-serif dark:text-txt-light text-txt-dark">The Recipes Only</h1>
					<h2 className="text-lg font-sans tracking-wide text-neutral-500 animate-fade">Search for any recipe and get just the recipe - nothing more</h2>
				...
				<Script src="https://www.googletagmanager.com/gtag/js?id=G-110EPPVXQX" strategy="afterInteractive" />
