	...
	return (
		<>
			<Head>
				...
				<meta name="description" content="Recipe generated by therecipesonly.com. Discover detailed recipe instructions, ingredient lists, and cooking tips to perfect your dish." />
				<meta name="viewport" content="width=device-width, initial-scale=1" />
				<meta name="keywords" content="recipe, cooking, ingredients, instructions, cuisine, food, culinary" />
				<meta property="og:title" content={`${recipe.name} - A Delicious Recipe`} />
				<meta property="og:description" content="Find out how to cook this amazing recipe with step-by-step instructions and expert tips." />
				{/* <meta property="og:image" content="/og-image.jpg" /> */}
				<meta property="og:type" content="article" />
				<meta property="og:url" content={`https://the-recipes-only.com/recipe/${recipe.name}`} />
				<meta name="twitter:card" content="summary_large_image" />
				<meta name="twitter:title" content={`${recipe.name} - A Delicious Recipe`} />
				<meta name="twitter:description" content="Get the full details on this recipe, including ingredients and cooking instructions." />
...
export async function getStaticPaths() {
	try {
		...
		console.log("getStaticPaths error:", err);
		return {
			paths: [],
			fallback: true,
		};
